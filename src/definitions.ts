...
export const DEFAULT_REQUEST_CONFIGURATION_OPTIONS: Readonly<
  Required<
    Pick<RequestConfigurationOptions, "maxAdContentRating" | "tagForChildDirectedTreatment" | "tagForUnderAgeOfConsent">
  > &
